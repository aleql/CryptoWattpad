      ...
      .then(function(book) {
        ...
        if (book_cnt % 2 == 1) {
          $("#books-left").append(
            ...
            `<a href="#modal"`+id+` class="secondary-content waves-effect waves-light btn modal-trigger" onclick=buyBook(` + id + `, ${book.price})><i class="material-icons left">attach_money</i>Comprar</a>`+
            ` </li>`+
